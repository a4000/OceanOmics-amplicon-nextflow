...
dada2_pooled <- function(voyage = voyage, 
  ...
  saveRDS(out, paste0(wd, "/03-dada2/tmpfiles/", voyage, "_", assay, "_filterAndTrim_out.rds"))
  ...
  #......................................................................................
  # CHECKPOINT Save the result
  save(errors_forward, errors_reverse, file = paste0(wd, "/03-dada2/errorModel/", voyage, "_", assay,"_pooled_error_rates.RData"))
  ...
  #......................................................................................
  # CHECKPOINT Save the result
  save(derep_forward, derep_reverse, file = paste0(wd, "/03-dada2/tmpfiles/", voyage, "_", assay, "_dereplicated.RData"))
  ...
  #......................................................................................
  # CHECKPOINT Save the result
  save(mergers, file = paste0(wd, "/03-dada2/tmpfiles/", voyage, "_", assay, "_merged.RData"))
  ...
  #......................................................................................
  # CHECKPOINT Save the result
  saveRDS(seq_table, file = paste0(wd, "/03-dada2/tmpfiles/", voyage, "_", assay,"_seq_tab.rds"))
  ...
  head(track_Fs)
  tail(track_Fs)
  write.table(track_Fs, file = paste0(wd, "/03-dada2/QC_plots/Track_reads_Fw_",assay))
  ...
  head(track_Rs)
  tail(track_Rs)
  write.table(track_Rs, file = paste0(wd, "/03-dada2/QC_plots/Track_reads_Rs_",assay))
