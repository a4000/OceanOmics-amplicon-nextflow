...
dada2_analysis1 <- function(voyage = voyage, 
  ...
  #......................................................................................
  # CHECKPOINT Save the result
  save(errors_forward, errors_reverse, file = paste0(wd, "/03-dada2/errorModel/", voyage, "_", assay,"_", site, "_error_rates.RData"))
  ...
  ggsave(plot = errorsplot_Fs, 
         filename = paste0(wd, "/03-dada2/QC_plots/", voyage, "_errorsplot_Fs_", assay,"_", site,".png"), 
         height = 5, 
         width = 7)
  errorsplot_Rs <- plotErrors(errors_reverse, nominalQ = TRUE)
  ggsave(plot = qualityprofile_Rs, 
         filename = paste0(wd, "/03-dada2/QC_plots/", voyage, "_errorsplot_Rs_", assay,"_", site, ".png"), 
         height = 5, 
         width = 7)
